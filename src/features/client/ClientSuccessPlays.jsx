...
const ClientSuccessPlays = ({ clientData }) => {
  ...
  const [successPlays] = React.useState([
    {
      id: 1,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Strategic playbooks and success initiatives for {clientData.name}</p>
        </div>
        <Dialog open={isAddPlayOpen} onOpenChange={setIsAddPlayOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Define a new strategic initiative for {clientData.name}
              </DialogDescription>
            </DialogHeader>
